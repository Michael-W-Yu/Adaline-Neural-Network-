...
ADALINE (ADaptive LInear NEuron) neural network for logistic regression
'''
import numpy as np
...
class AdalineLogistic():
    ...
    def compute_loss(self, y, net_act):
        ...
        '''
        return np.sum(np.multiply(-y,np.log(net_act))-np.multiply((1-y),np.log(1-net_act)))
    ...
    def predict(self, features):
        ...
        #return (self.activation(self.net_input(features)))
